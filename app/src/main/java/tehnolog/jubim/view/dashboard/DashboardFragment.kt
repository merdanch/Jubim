package tehnolog.jubim.view.dashboard
...
import tehnolog.jubim.utils.viewState.ViewState
...
import tehnolog.jubim.databinding.FragmentDashboardBinding
import tehnolog.jubim.view.adapter.TransactionAdapter
...
class DashboardFragment :
    ...
    private fun onTotalTransactionLoaded(transaction: List<Transaction>) = with(binding) {
        ...
        incomeCardView.total.text = "+ ".plus(turkmenManat(income))
        expenseCardView.total.text = "- ".plus(turkmenManat(expense))
        totalBalanceView.totalBalance.text = turkmenManat(income - expense)
    }
